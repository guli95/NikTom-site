...
import asset1 from "../../images/4brony-talerzowe/Megatron z UT/megatron przod.png";
import asset2 from "../../images/4brony-talerzowe/Megatron z UT/megatron tyl.png";
import asset3 from "../../images/4brony-talerzowe/Megatron z UT/IMG_8777.jpg";
import PrizeBtn from "../../components/PrizeBtn";
import data from "../../data";

const info = data.filter((item) => {
  if (item.route === "/brony-talerzowe/kompaktowa-megatron-xl-tolmet") {
    return item;
  }
});
const MegatronXL = () => (
