...
import asset1 from "../../images/4brony-talerzowe/Astat z UT/astat z urzadzeniem trakcyjnym kolory.png";
import asset2 from "../../images/4brony-talerzowe/Astat z UT/astat z urządzeniem trakcyjnym.png";

import PrizeBtn from "../../components/PrizeBtn";
import data from "../../data";

const info = data.filter((item) => {
  if (item.route === "/brony-talerzowe/kompaktowa-astat-model-II-tolmet") {
    return item;
  }
});
const AstatModelII = () => (
