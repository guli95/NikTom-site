...
const info = data.filter((item) => {
  if (item.route === "/agregaty-uprawowe-hydropak/talerz-tiger") {
    return item;
  }
});
const Tiger = () => (
    ...
    <div className="wrapper">
      ...
      <div className="box">
        <ItemInfo
          ...
          raw2={["Liczba siłowników", "2", "2", "2", "2", "2"]}
          ...
          raw5={["Rozstaw rzędów talerzy", "65", "65", "65", "65", "65"]}
          raw6={["Masa [kg]", "1140", "1165", "1240", "1550", "1750"]}
          raw7={[
            "Zapotrzebowanie [KM]",
            "90 - 120",
            "100 - 130",
