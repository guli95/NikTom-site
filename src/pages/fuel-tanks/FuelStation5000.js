...
const info = data.filter((item) => {
  if (item.route === "/zbiorniki-paliwa/dwuplaszczowy-5000") {
    return item;
  }
});
const FuelStation5000 = () => (
  <div>
    <Navigation />
    <div className="wrapper">
      ...
      <div className="description">
        <ul>
          ...
          <li>
            <span>
              zbrojony wąż zasycający 1" z zaworem przeciwzwrotnym i filtrem
              siatkowym
            </span>
          </li>
          <li>
          ...
          <li>
            <span>
              4 uchwyty transportowe umożliwiające bezpieczne podnoszenie
              zbiornika
            </span>
          </li>
        </ul>
        <ul>
          ...
          <li>
            <span>zwijadło automatyczne z wężem do 15m</span>
          </li>
          <li>
          ...
          <li>
            <span>
              zewnętrzna linia napełniająca 2" z zaworem odcinającym spill-stop
            </span>
          </li>
          <li>
          ...
          <li>
            <span>wydajniejsza pompa PIUSI E120 95l/min</span>
          </li>
          <li>
      ...
      <div className="box">
        <ItemInfo
          ...
          rawNumber={6}
          colNumber={2}
          raw1={["Pojemność [l]", "5000"]}
          raw2={["Długość [m]", "2,95"]}
          raw3={["Szerokość [m]", "2,38"]}
          raw4={["wysokość [m]", "2,04"]}
...
export default FuelStation5000;
