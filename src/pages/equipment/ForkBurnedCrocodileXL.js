...
const info = data.filter((item) => {
  if (item.route === "/osprzet/szuflo-krokodyl-xl-zab-palony") {
    return item;
  }
});
const ForkBurnedCrocodileXL = () => (
  <div>
    <Navigation />
    <div className="wrapper">
      ...
      <div className="box">
        <ItemInfo
          ...
          raw2={["Pojemność [m3]", "1,9", "2,1", "2,3", "2,5"]}
          raw3={["Waga [kg]", "550", "610", "670", "720"]}
        />
        <PrizeBtn />
...
export default ForkBurnedCrocodileXL;
