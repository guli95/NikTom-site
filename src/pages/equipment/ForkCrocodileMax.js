...
const info = data.filter((item) => {
  if (item.route === "/osprzet/szuflo-krokodyl-max") {
    return item;
  }
});
const ForkCrocodileMax = () => (
  <div>
    <Navigation />
    <div className="wrapper">
      ...
      <div className="box">
        <ItemInfo
          ...
          raw2={["Pojemność [m3]", "0,6", "0,7", "0,8", "1,0", "1,3"]}
          raw3={["Waga [kg]", "440", "480", "520", "550", "610"]}
        />
        <PrizeBtn />
...
export default ForkCrocodileMax;
