...
const info = data.filter((item) => {
  if (item.route === "/osprzet/lycha-do-wozka-widlowego-pojemnosciowa") {
    return item;
  }
});
const BucketCapactive = () => (
  <div>
    <Navigation />
    <div className="wrapper">
      ...
      <div className="box">
        <ItemInfo
          ...
          rawNumber={3}
          colNumber={7}
          raw1={["Pojemność [m3]", "1,0", "1,5", "2,0"]}
          raw2={["Waga [kg]", "340", "390", "450"]}
        />
        <PrizeBtn />
...
export default BucketCapactive;
