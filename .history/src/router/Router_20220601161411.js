...
import Xsara600 from "../pages/mounted-sprayers/Xsara600";
import Xsara800 from "../pages/mounted-sprayers/Xsara800";
import Xsara1000 from "../pages/mounted-sprayers/Xsara1000";
import Xsara1200 from "../pages/mounted-sprayers/Xsara1200";
import PromarHX from "../pages/mounted-sprayers/PromarHX";
import PromarHU from "../pages/mounted-sprayers/PromarHU";
import PromarHI from "../pages/mounted-sprayers/PromarHI";
    ...
    <HashRouter>
      <ScrollToTop>
        <Routes>
          ...
          ></Route>
          <Route
            path="/opryskiwacze-zawieszane/xsara-600"
            element={<Xsara600 />}
          ></Route>
          <Route
            path="/opryskiwacze-zawieszane/xsara-800"
            element={<Xsara800 />}
          ></Route>
          <Route
            path="/opryskiwacze-zawieszane/xsara-1000"
            element={<Xsara1000 />}
          ></Route>
          <Route
            path="/opryskiwacze-zawieszane/xsara-1200"
            element={<Xsara1200 />}
          ></Route>
          <Route
            path="/opryskiwacze-zawieszane/promar-hx"
            element={<PromarHX />}
          ></Route>
          <Route
            path="/opryskiwacze-zawieszane/promar-hu"
            element={<PromarHU />}
          ></Route>
          <Route
            path="/opryskiwacze-zawieszane/promar-hi"
            element={<PromarHI />}
          ></Route>
        </Routes>
      </ScrollToTop>
