...
const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-ciagane/bruno-1200-tolmet") {
    return item;
  }
});
const Bruno1200Tolmet = () => (
  <div>
    <Navigation />
    <div className="wrapper">
      ...
      <div className="description">
        <ul className="long-list">
          ...
          <li>
            <span>rozdzielacz stałociśnieniowy Fermo 5 sekcyjny</span>
          </li>
          <li>
...
export default Bruno1200Tolmet;
