...
import asset1 from "../../images/15opryskiwacze-ciagane/Borys 2500/borys 2518 front.png";
import asset2 from "../../images/15opryskiwacze-ciagane/Borys 2500/borys 2518 back.png";
import PrizeBtn from "../../components/PrizeBtn";
import data from "../../data";

const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-ciagane/borys-2500-tolmet") {
    return item;
  }
});
const Borys2500 = () => (
    ...
    <div className="wrapper">
      ...
      <div className="box">
        <ItemInfo
          ...
          raw2={["Pojemność zbiornika [l]", "2500", "2500", "2500", "2500"]}
