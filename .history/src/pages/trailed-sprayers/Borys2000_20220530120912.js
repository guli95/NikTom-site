...
import asset1 from "../../images/15opryskiwacze-ciagane/Borys 2000/przód 2015 borys zielony.png";
import asset2 from "../../images/15opryskiwacze-ciagane/Borys 2000/tyl 2015 borys zielony.png";
import PrizeBtn from "../../components/PrizeBtn";
import data from "../../data";

const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-ciagane/borys-2000-tolmet") {
    return item;
  }
});
const Borys2000 = () => (
    ...
    <div className="wrapper">
      ...
      <div className="description">
        <ul className="long-list">
          ...
          <li>
            <span>typ zbiornika PROTON 2000</span>
          </li>
          <li>
          ...
          <li>
            <span>dwie pompy TOLVERI PU-3/140 o wydajności 2x 140 l/min</span>
          </li>
          <li>
      ...
      <div className="box">
        <ItemInfo
          ...
          raw2={["Pojemność zbiornika [l]", "2000", "2000", "2000", "2000"]}
