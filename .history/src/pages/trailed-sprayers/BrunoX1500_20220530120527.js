...
const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-ciagane/bruno-x-1500-tolmet") {
    return item;
  }
});
const BrunoX1500Tolmet = () => (
  <div>
    <Navigation />
    <div className="wrapper">
      ...
      <div className="description">
        <ul className="long-list">
          ...
          <li>
            <span>dwie pompy TOLVERI PU-3/140 o wydajność 2x 140 l/min</span>
          </li>
          <li>
      ...
      <div className="box">
        <ItemInfo
          ...
          rawNumber={7}
          colNumber={4}
          raw1={["Model", "Bruno X 1512", "Bruno X 1515"]}
          raw2={["Pojemność zbiornika [l]", "1500", "1500"]}
          raw3={["Szerokość lancy [m]", "12", "15"]}
          raw4={["Waga opryskiwacza bez cieczy[kg]", "1800", "1850"]}
...
export default BrunoX1500Tolmet;
