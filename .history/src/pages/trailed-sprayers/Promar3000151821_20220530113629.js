...
const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-ciagane/3000-15-18-21-promar") {
    return item;
  }
});
const Promar3000151821 = () => (
  <div>
    <Navigation />
    <div className="wrapper">
      ...
      <div className="description">
        <ul>
          ...
          <li>
            <span>
              Belka polowa o szerokości 15 lub 18 lub 21m z wahadłowym układem
          ...
          <li>
            <span>Pompa włoskiej firmy UDOR o wydajności 200l/min</span>
          </li>
          <li>
            <span>
          ...
          <li>
            <span>Dyszel prosty na dolny zaczep ciągnika</span>
          </li>
      ...
      <div className="box">
        <ItemInfo
          ...
          rawNumber={9}
          colNumber={2}
          raw1={["Pojemność zbiornika (l) ", "3000"]}
          raw2={["Typ zbiornika", "żywiczny"]}
          raw3={["Szerokość belki [m]", "15 lub 18 lub 21"]}
          raw4={["Liczba sekcji roboczych [szt]", "5 lub 7(opcja)"]}
...
export default Promar3000151821;
