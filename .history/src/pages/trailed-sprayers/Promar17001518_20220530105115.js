...
const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-ciagane/1700-15-18-promar") {
    return item;
  }
});
const Promar17001518 = () => (
  <div>
    <Navigation />
    <div className="wrapper">
      ...
      <div className="description">
        <ul>
          ...
          <li>
            <span>
              Zbiornik 1700 litrów wykonany z żywicy z dodatkowym zbiornikiem na
              czystą wodę do płukania o pojemności 100 litrów
            </span>
          </li>
          <li>
            <span>
              Belka polowa o szerokości 15 lub 18 m rozkładana hydraulicznie z
              siłownikiem stabilizacji, podnoszona hydraulicznie. Belka dzielona
              standardowo na 5 sekcji
            </span>
          </li>
          ...
          <li>
            <span>Belka malowana proszkowo</span>
          </li>
        ...
        <ul>
          ...
          <li>
            <span>Zaczep obrotowo - skrętny</span>
          </li>
        </ul>
      </div>
      <div className="box">
        <ItemInfo
          ...
          rawNumber={9}
          colNumber={2}
          raw1={["Pojemność zbiornika (l) ", "1700"]}
