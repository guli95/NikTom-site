...
const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-ciagane/2021-hu-promar") {
    return item;
  }
});
const Promar2021HU = () => (
    ...
    <div className="wrapper">
      ...
      <div className="description">
        <ul>
          ...
          <li>
            <span>
              Belka polowa o szerokości 21 m włoskiej firmy BARGAM. Podnoszona i
              rozkładana hydraulicznie niezależnie (jednostronnie) z możliwością
              rozłożenia 1/4 belki
            </span>
          </li>
          <li>
          ...
          <li>
            <span>
              Pompa włoskiej produkcji UDOR o wydajności 200 l/min zapewnia
          ...
          <li>
            <span>
              Ręczny zawór stałociśnieniowy firmy ARAG (5 sekcji roboczych)
              zapewniający stałe ciśnienie bez względu na zmianę ilości
              pracujących sekcji
            </span>
          </li>
