...
const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-ciagane/bruno-x-2000-tolmet") {
    return item;
  }
});
const BrunoX2000Tolmet = () => (
  <div>
    <Navigation />
    <div className="wrapper">
      ...
      <div className="box">
        <ItemInfo
          ...
          rawNumber={7}
          colNumber={4}
          raw1={["Model", "Bruno X 2012", "Bruno X 2015"]}
          raw2={["Pojemność zbiornika [l]", "2000", "2000"]}
          raw3={["Szerokość lancy [m]", "12", "15"]}
          raw4={["Waga opryskiwacza bez cieczy[kg]", "2100", "2150"]}
          raw5={["Długość [mm]", "4000", "4000"]}
...
export default BrunoX2000Tolmet;
