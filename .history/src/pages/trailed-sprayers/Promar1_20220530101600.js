...
const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-ciagane/promar-1200-12-15") {
    return item;
  }
});
const Promar1 = () => (
        ...
        <ul>
          ...
          <li>
            <span>
              ...
              czystą wodę do płukania o pojemności 60 litrów
            </span>
          </li>
          <li>
            <span>
              Belka polowa o szerokości 12/15m podnoszona hydraulicznie
            </span>
          </li>
          <li>
            <span>
