...
import asset1 from "../../images/14opryskiwacze-zawieszane/Xsara 1000/Xsara 1015 front.png";
import asset2 from "../../images/14opryskiwacze-zawieszane/Xsara 1000/Xsara 1015 back.png";
import PrizeBtn from "../../components/PrizeBtn";
import data from "../../data";

const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-zawieszane/xsara-1000") {
    return item;
  }
});
const Xsara1000 = () => (
    ...
    <div className="wrapper">
      ...
      <div className="description">
        <ul>
          ...
          <li>
            <span>
              ocynkowana belka polowa o szerokości 12m lub 15m lub 18m
            </span>
          </li>
          <li>
      ...
      <div className="box">
        <ItemInfo
          ...
          rawNumber={3}
          colNumber={3}
          raw1={["Symbol", "Xsara 1012", "Xsara 1015", "Xsara 1018"]}
          raw2={["Szerokość lancy [m]", "12", "15", "18"]}
          raw3={["Waga bez cieczy", "680", "750", "800"]}
        />
        <PrizeBtn />
