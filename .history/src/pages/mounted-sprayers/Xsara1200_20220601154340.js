...
import asset1 from "../../images/14opryskiwacze-zawieszane/Xsara 1200/Xsara 1215 front.png";
import asset2 from "../../images/14opryskiwacze-zawieszane/Xsara 1200/Xsara 1200 back.png";
import PrizeBtn from "../../components/PrizeBtn";
import data from "../../data";

const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-zawieszane/xsara-1200") {
    return item;
  }
});
const Xsara1200 = () => (
    ...
    <div className="wrapper">
      ...
      <div className="box">
        <ItemInfo
          ...
          rawNumber={3}
          colNumber={3}
          raw1={["Symbol", "Xsara 1212", "Xsara 1215", "Xsara 1218"]}
          raw2={["Szerokość lancy [m]", "12", "15", "18"]}
          raw3={["Waga bez cieczy", "723", "773", "823"]}
        />
        <PrizeBtn />
