...
import asset1 from "../../images/14opryskiwacze-zawieszane/zdjcia 815 HI/DSCN4193.JPG";
import asset2 from "../../images/14opryskiwacze-zawieszane/zdjcia 815 HI/DSCN4195.JPG";
import asset3 from "../../images/14opryskiwacze-zawieszane/zdjcia 815 HI/DSCN4197.JPG";
import asset4 from "../../images/14opryskiwacze-zawieszane/zdjcia 815 HI/DSCN4198.JPG";
import asset5 from "../../images/14opryskiwacze-zawieszane/zdjcia 815 HI/DSCN4200.JPG";
import PrizeBtn from "../../components/PrizeBtn";
import data from "../../data";

const info = data.filter((item) => {
  if (item.route === "/opryskiwacze-zawieszane/promar-hi") {
    return item;
  }
});
const PromarHI = () => (
    ...
    <div className="wrapper">
      ...
      <div className="description">
        <ul>
          ...
          <li>
            <span>Belka polowa 15m Bagram</span>
          </li>
        </ul>
        <ul>
