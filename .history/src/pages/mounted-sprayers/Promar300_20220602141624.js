    ...
    <div className="wrapper">
      ...
      <div className="description">
        ...
        <ul>
          ...
          <li>
            <span>Potrójne oprawy rozpylacza</span>
          </li>

          <li>
            <span>Rozdzielacz stałociśnieniowy Tolmet 3-sekcyjny</span>
          </li>
          <li>
            <span>Zmiana pompy AP 100 na włoską 100 l/min</span>
          </li>
          <li>
            <span>Zmiana pompy AP 100 na włoską 140 l/min</span>
          </li>
          <li>
            <span>Podnoszenie hydrauliczne</span>
          </li>
          <li>
            <span>Dysze eżektorowe ceramiczne ASJ</span>
          </li>
          <li>
            <span>Dysze eżektorowe dwustrumieniowe ASJ</span>
          </li>
          <li>
          ...
          <li>
            <span>Rozwadniacz włoski Polmac 35l</span>
          </li>
        </ul>
      </div>
      <div className="box">
