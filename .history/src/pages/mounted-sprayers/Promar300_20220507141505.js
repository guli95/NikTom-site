        ...
        <ul>
          ...
          <li>
            <span>
              ...
              powietrznika ma eliminować pulsację cieczy
            </span>
          </li>
          <li>
            <span>
              Mieszadło hydrauliczne zapewnia utrzymanie jednakowego stężenia
              cieczy roboczej
            </span>
          </li>
          <li>
          ...
          <li>
            <span>
              Rozdzielacz czterosekcyjny ( trzy sekcje przeznaczone jest na
              belkę a czwarta na zasilanie rozwadniacza)
            </span>
          </li>
          <li>
            <span>
