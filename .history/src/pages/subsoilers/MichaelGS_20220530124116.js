    ...
    <div className="wrapper">
      ...
      <div className="description">
        ...
        <ul>
          ...
          <li>
            <span>Wał tylny packer (śr. 450)</span>
          </li>
          <li>
            <span>Wał tylny crosskill (śr. 400)</span>
          </li>
          <li>
            <span>Wał tylny gumowy (śr. 500)</span>
          </li>
          <li>
            <span>Wał tylny podwójny kolczasty z hydr. regulacją pracy</span>
          </li>
        </ul>
      </div>
      <div className="box">
