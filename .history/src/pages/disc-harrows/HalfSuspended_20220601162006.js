  ...
  <div>
    ...
    <div className="wrapper">
      ...
      <ul>
        ...
        <span>
          <li>Wał tylny packer (śr. 500 mm)</li>
        </span>
        <span>
          <li>Wał tylny crosskill (śr. 400 mm)</li>
        </span>
        <span>
          <li>Wał tylny pierścieniowy (śr. 500 mm)</li>
        </span>
        <span>
          <li>Wał tylny gumowy (śr. 500 mm)</li>
        </span>
        <span>
          <li>Wał tylny teownikowy (śr. 500 mm)</li>
        </span>
        <span>
          <li>Wał tylny daszkowy (śr. 500 mm)</li>
        </span>
        <span>
          <li>Wał tylny ceownikowy (śr. 500 mm)</li>
        </span>
        <span>
          <li>Wał tylny dyskowy (śr. 500 mm)</li>
        </span>
        <span>
          <li>Talerze 610 mm</li>
        </span>
        <span>
          <li>Piasty SKF</li>
        </span>
